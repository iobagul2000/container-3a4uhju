...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3a4uhju.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3a4uhju.containers.anotherwebservice.com/
...
```
git clone git@github.com:iobagul2000/container-3a4uhju.git
cd container-3a4uhju
```
...
```
docker attach container-3a4uhju
```
